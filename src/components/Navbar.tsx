      ...
      <div className="container mx-auto px-4 py-4">
        ...
        {isMenuOpen && <div className="md:hidden mt-4 pb-4">
            <div className="flex flex-col space-y-4">
              <Link to="/" className="text-kap-navy hover:text-kap-blue font-medium" onClick={toggleMenu}>
                Beranda
              </Link>
              <Link to="/tentang-kami" className="text-kap-navy hover:text-kap-blue font-medium" onClick={toggleMenu}>
                Tentang Kami
              </Link>
              <Link to="/layanan" className="text-kap-navy hover:text-kap-blue font-medium" onClick={toggleMenu}>
                Layanan
              </Link>
              <Link to="/tim-kami" className="text-kap-navy hover:text-kap-blue font-medium" onClick={toggleMenu}>
                Tim Kami
              </Link>
              <Link to="/kontak" className="text-kap-navy hover:text-kap-blue font-medium" onClick={toggleMenu}>
                Kontak
              </Link>
