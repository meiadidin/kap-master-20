        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-gray-600">
              KAP Indonesia menyediakan berbagai layanan akuntansi dan keuangan yang disesuaikan dengan kebutuhan spesifik bisnis Anda. Dengan keahlian mendalam di berbagai industri, kami membantu Anda mencapai kepatuhan, efisiensi, dan pertumbuhan.
            </p>
          </div>
